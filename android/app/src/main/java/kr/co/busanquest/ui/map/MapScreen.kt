package kr.co.busanquest.ui.map
...
import kr.co.busanquest.ui.theme.pressableRow
...
fun MapScreen(
    ...
    var selectedMission by remember { mutableStateOf<kr.co.busanquest.data.model.OngoingMission?>(null) }
